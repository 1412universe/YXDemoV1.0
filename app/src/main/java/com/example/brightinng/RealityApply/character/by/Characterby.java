package com.example.brightinng.RealityApply.character.by;
...
public class  Characterby extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_characterby);
        ...
        mylinearlayout = findViewById(R.id.by);

        Button jianjie = findViewById(R.id.bybutton);
        Button fenxi = findViewById(R.id.bybutton2);
        Button tubiao = findViewById(R.id.bybutton3);
        Button daoru = findViewById(R.id.bybutton4);
        ...
        jianjie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ImageView jianjie = new ImageView(Characterby.this);
                jianjie.setImageResource(R.drawable.train_boyajieshao);


                LinearLayout.LayoutParams p = new LinearLayout.LayoutParams(
                        dip2px(Characterby.this, 434),
                        dip2px(Characterby.this, 204)
                );


                p.setMargins(dip2px(Characterby.this, 10),
                        dip2px(Characterby.this, 10),
                        dip2px(Characterby.this, 0),
                        dip2px(Characterby.this, 0));
        ...
        tubiao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                b1.setMargins(dip2px(Characterby.this, 0),
                        dip2px(Characterby.this, 70),
                        dip2px(Characterby.this, 0),
                        dip2px(Characterby.this, 0));

                b2.setMargins(dip2px(Characterby.this, 0),
                        dip2px(Characterby.this, 70),
                        dip2px(Characterby.this, 0),
                        dip2px(Characterby.this, 0));
                ...
                LinearLayout.LayoutParams l = new LinearLayout.LayoutParams(
                        dip2px(Characterby.this, 350),
                        dip2px(Characterby.this, 200)


                );


                l.setMargins(dip2px(Characterby.this, 0),
                        dip2px(Characterby.this, 10),
                        dip2px(Characterby.this, 0),
                        dip2px(Characterby.this, 0));

                LinearLayout.LayoutParams tubiaol = new LinearLayout.LayoutParams(
                        dip2px(Characterby.this, 299),
                        dip2px(Characterby.this, 160)


                );


                tubiaol.setMargins(dip2px(Characterby.this, 25),
                        dip2px(Characterby.this, 20),
                        dip2px(Characterby.this, 0),
                        dip2px(Characterby.this, 0));
